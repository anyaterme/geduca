...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'web_chapter', 'body', self.gf('django.db.models.fields.CharField')(max_length=20000))

    def backwards(self, orm):

        # Changing field 'Chapter.body'
        db.alter_column(u'web_chapter', 'body', self.gf('django.db.models.fields.CharField')(max_length=2000))
