...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Message.last_update'
        db.alter_column(u'web_message', 'last_update', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Message.last_update'
        db.alter_column(u'web_message', 'last_update', self.gf('django.db.models.fields.DateTimeField')())
