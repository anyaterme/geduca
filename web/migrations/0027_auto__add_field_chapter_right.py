...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Chapter.right'
        db.add_column(u'web_chapter', 'right',
                      self.gf('ckeditor.fields.RichTextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Chapter.right'
        db.delete_column(u'web_chapter', 'right')
    ...
    models = {
        ...
        u'web.chapter': {
            ...
            'right': ('ckeditor.fields.RichTextField', [], {'default': "''"}),
