...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field tag on 'Course'
        m2m_table_name = db.shorten_name(u'web_course_tag')
    ...
    def backwards(self, orm):
        # Removing M2M table for field tag on 'Course'
        db.delete_table(db.shorten_name(u'web_course_tag'))
    ...
    models = {
        ...
        u'web.course': {
            ...
            'tag': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'tag_course'", 'null': 'True', 'to': u"orm['web.Tag']"})
        },
        u'web.courseuser': {
