...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Chapter.body'
        db.alter_column(u'web_chapter', 'body', self.gf('ckeditor.fields.RichTextField')())

    def backwards(self, orm):
        # Adding model 'Image'
        db.create_table(u'web_image', (
            ('chapter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Chapter'], null=True, blank=True)),
        ...
        # Changing field 'Chapter.body'
        db.alter_column(u'web_chapter', 'body', self.gf('django.db.models.fields.TextField')())
