...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.cep_link'
        db.add_column(u'web_course', 'cep_link',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.cep_link'
        db.delete_column(u'web_course', 'cep_link')
    ...
    models = {
        ...
        u'web.theme': {
            'Meta': {'ordering': "['creation_date']", 'object_name': 'Theme'},
