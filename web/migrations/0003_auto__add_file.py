...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'web_file', (
            ...
            ('message', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Message'])),
            ('version', self.gf('django.db.models.fields.FloatField')(default=1.0)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal(u'web', ['File'])


    def backwards(self, orm):
        # Deleting model 'File'
        db.delete_table(u'web_file')
    ...
    models = {
        ...
        u'web.file': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['web.Message']"}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'version': ('django.db.models.fields.FloatField', [], {'default': '1.0'})
        },
        u'web.message': {
