...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'web', ['Tags'])
        ...
        db.create_table(u'web_category', (
            ...
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Category'], null=True, blank=True)),
        ))
        db.send_create_signal(u'web', ['Category'])

        # Adding M2M table for field manager on 'Category'
        m2m_table_name = db.shorten_name(u'web_category_manager')
        ...
        # Adding M2M table for field tutor on 'Course'
        m2m_table_name = db.shorten_name(u'web_course_tutor')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('course', models.ForeignKey(orm[u'web.course'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
    ...
    def backwards(self, orm):
        # Deleting model 'Tags'
        db.delete_table(u'web_tags')

        # Deleting model 'Category'
        db.delete_table(u'web_category')

        # Removing M2M table for field manager on 'Category'
        db.delete_table(db.shorten_name(u'web_category_manager'))

        # Deleting model 'Course'
        db.delete_table(u'web_course')

        # Removing M2M table for field tutor on 'Course'
        db.delete_table(db.shorten_name(u'web_course_tutor'))
