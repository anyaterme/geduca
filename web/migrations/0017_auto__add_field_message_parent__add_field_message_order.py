...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'web_message', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['web.Message'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'web_message', 'parent_id')
    ...
    models = {
        ...
        u'web.message': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['web.Message']", 'null': 'True'}),
