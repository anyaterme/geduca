...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'web_chapter', (
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Chapter'], null=True, blank=True)),
            ('theme', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Theme'])),
        ))
        db.send_create_signal(u'web', ['Chapter'])

        # Adding model 'Theme'
        db.create_table(u'web_theme', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modification_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ...
        db.send_create_signal(u'web', ['Theme'])


        # Changing field 'CourseUser.date'
        db.alter_column(u'web_courseuser', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):
        # Deleting model 'Chapter'
        db.delete_table(u'web_chapter')

        # Deleting model 'Theme'
        db.delete_table(u'web_theme')


        # Changing field 'CourseUser.date'
        db.alter_column(u'web_courseuser', 'date', self.gf('django.db.models.fields.DateTimeField')())
